...
#   ARGN = proto files
#
# PROTOBUF_GENERATE_C (same but uses protobuf-c)
#
#  ====================================================================
...
function(PROTOBUF_GENERATE_C SRCS HDRS)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND  ${PROTOBUF_PROTOCC_EXECUTABLE}
...
find_program(PROTOBUF_PROTOCC_EXECUTABLE
    NAMES protoc-c
...
mark_as_advanced(PROTOBUF_PROTOCC_EXECUTABLE)
